...
export const NewHabitForm = () => {
  ...
  return (
    ...
    >
        ...
        {availableWeekDays.map((weekdays, index) => {
          return (
            <Checkbox.Root
              ...
              className="flex items-center gap-3 group mt-3 focus:outline-none"
            >
      ...
      <button
        type="submit"
        className="mt-6 rounded-lg p-4 flex items-center gap-3 font-semibold bg-green-600 justify-center hover:bg-green-500 transition-colors focus:outline focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-zinc-900"
      >
        <Check
          size={20}
          weight="bold"
